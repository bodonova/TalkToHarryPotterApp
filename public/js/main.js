...
//var AskHarry = require('/Users/brianodonovan/SpeechToSpeech/potter/AskHarry.js');
//console.log ('require paths = '+process.env.NODE_PATH);
//var AskHarry = require('./AskHarry.js');
...
function translate(textContent) {
  ...
  // console.log ('In Text '+textContent);

  // replace with call to Harry conversational
  // console.log ('Asking Harry: '+textContent);
  // AskHarry.ask_harry(textContent, got_answer);
  //got_answer(textContent, "Harry doesn't know "+textContent);
  ...
  //textContent = 'Harry is thinking about your question: '+textContent;

  //console.log ('Out Text '+textContent);
  //$('#translation textarea').val(textContent);
  //TTS(textContent);
...
//   $('#translation textarea').val(answerText);
//   TTS(answerText);
// }
...
exports.initPlaySample = function(ctx) {
  ...
  (function() {
    ...
    //alert ('function for play-sample-1 in main.js with '+fileName);
    el.off('click');
    var iconName = 'play';
  ...
  (function() {
    ...
    // alert ('function for play-sample-2 in main.js with '+fileName);
    el.off('click');
    var iconName = 'play';
    var imageTag = el.find('img');
    el.click( function(evt) {
    ...
    (function() {
      var fileName = 'audio/' + LOOKUP_TABLE[ctx.currentModel][2];
      var el = $('.play-sample-3');
      // alert ('function for play-sample-3 in main.js with '+fileName);
      el.off('click');
      var iconName = 'play';
      var imageTag = el.find('img');
      el.click( function(evt) {
    ...
    (function() {
      var fileName = 'audio/' + LOOKUP_TABLE[ctx.currentModel][3];
      var el = $('.play-sample-4');
      // alert ('function for play-sample-4 in main.js with '+fileName);
      el.off('click');
      var iconName = 'play';
      var imageTag = el.find('img');
      el.click( function(evt) {
